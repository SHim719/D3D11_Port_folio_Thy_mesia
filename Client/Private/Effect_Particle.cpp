...
HRESULT CEffect_Particle::Initialize_Prototype(ifstream& fin)
{
...
_bool CEffect_Particle::Update_SpawnTime(size_t iIdx, _float fTimeDelta)
{
...
void CEffect_Particle::Update_Positions(size_t iIdx, _float fTimeDelta)
{
...
void CEffect_Particle::Update_Scale(size_t iIdx)
{
...
void CEffect_Particle::Update_Rotation(size_t iIdx, _float fTimeDelta)
{
...
void CEffect_Particle::Update_Velocity(size_t iIdx, _float fTimeDelta)
{
	_vector vVelocity = XMLoadFloat3(&m_NowParticleDatas[iIdx].vVelocity);
...
void CEffect_Particle::Update_Color(size_t iIdx)
{
...
void CEffect_Particle::Update_Lifetime(size_t iIdx, _float fTimeDelta)
{
...
void CEffect_Particle::Update_BoneMatrix()
{
...
HRESULT CEffect_Particle::Load_EffectData(ifstream& fin)
{
...
void CEffect_Particle::Restart_Effect(EFFECTSPAWNDESC* pDesc)
{
...
void CEffect_Particle::Restart_Particle(size_t iIdx)
{
	memcpy(&m_NowParticleDescs[iIdx], &m_InitParticleDescs[iIdx], sizeof(PARTICLE_DESC));

}

void CEffect_Particle::Remake_Particle()
{
	for (size_t i = 0; i < m_NowParticleDatas.size(); ++i)
	{
...
void CEffect_Particle::Resize_Particles(_uint iNumParticles)
{
	if (0 == iNumParticles)
		return;
...
HRESULT CEffect_Particle::Bind_GlobalVariables()
{
...
CEffect_Particle* CEffect_Particle::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, ifstream& fin)
{
