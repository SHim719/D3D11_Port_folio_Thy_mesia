...
namespace Engine
{
	...
	const D3D11_INPUT_ELEMENT_DESC VTXPARTICLE_DECLARATION::Elements[] = {
		...
		{ "VELOCITY", 0, DXGI_FORMAT_R32G32B32_FLOAT, 1, 64, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
		{ "LIFETIME", 0, DXGI_FORMAT_R32_FLOAT, 1, 76, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
		{ "INDEX", 0, DXGI_FORMAT_R32_SINT, 1, 80, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
	};
