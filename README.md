...
- 특정 함수 호출 시점에서 발생하는 문제를 해결하기 위해 이벤트 매니저를 설계했습니다. 이를 통해 호출 시점으로 인한 문제들을 효과적으로 해결할 수 있었습니다.
...
- 이 덕분에 모델 로드 시간이 기하급수적으로 감소하였고, 모델을 하나 로드하는 데 대략 1분에서 3초 정도로 대폭 개선되었습니다.
